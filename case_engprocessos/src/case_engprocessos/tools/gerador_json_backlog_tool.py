...
class BacklogPayloadInput(BaseModel):
    solicitacao_original: str = Field(
        ...,
        description="Texto original da solicitação recebida."
    )
    ...
    processo_impactado: str = Field(
        ...,
        description="Processo operacional impactado."
    )
    ...
    score_criticidade: float = Field(
        ...,
        description="Score de criticidade."
    )

    impacto_operacional: str = Field(
        ...,
        description="Descrição do impacto operacional."
    )

    gargalos: List[str] = Field(
        default_factory=list,
        description="Lista de gargalos identificados."
    )

    causas_raiz: List[str] = Field(
        default_factory=list,
        description="Lista de possíveis causas-raiz."
    )

    abordagem_recomendada: str = Field(
        ...,
    ...
    encaminhamento: str = Field(
        ...,
        description="Encaminhamento recomendado."
    )
...
class GeradorJSONBacklogTool(BaseTool):
    ...
    description: str = (
        "Gera um payload JSON estruturado para integração "
        "com sistemas corporativos de backlog."
    )
